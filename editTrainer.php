...
<head>
    <meta charset="utf-8">
    <title>Pokemon CMS - Edit Trainer </title>
    <link rel="stylesheet" href="styles.css" type="text/css">
</head>
<body>
    <div id="wrapper">
        <div id="header">
            <h1><a href="index.php">Pokemon CMS - Edit Trainer</a></h1>
...
<div id="all_blogs">
  <form action="post_processTrainer.php" method="post">
    <fieldset>
      <legend>Edit</legend>
      <p>
        <label for="name">Name</label>
        <input name="name" id="name" value="<?= $trainer['Name'] ?>" />
      </p>
      <p>
        <label for="type">Main Type</label>
        <input name="type" id="type" value="<?= $trainer['Type'] ?>"/>
      </p>
      <p>
        <label for="location">Location</label>
        <input name="location" id="location" value="<?= $trainer['Location'] ?>"/>
      </p>
      <p>
